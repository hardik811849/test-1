              ...
              <div data-aos-duration='700' data-aos='fade-up'>
                <div className='contact-detail-wrap'>
                  ...
                  <div className='invst-wrap'>
                    ...
                    <a
                      href='mailto:jay@hydrogen196.com'
                  ...
                  {/* <div className="invst-wrap">
                    ...
                    <a
                      href="mailto:mshoemaker@hydrogen196.com"
                      className="contact-link"
                    >
                      mshoemaker@hydrogen196.com
                    </a>
                  </div>
                  ...
                  <div className="invst-wrap">
                    ...
                    <a
                      href="mailto:adavidoff@hydrogen196.com"
                      className="contact-link"
                    >
                      adavidoff@hydrogen196.com
                    </a>
                  </div> */}
                </div>
              </div>
              ...
              <div className="media-inq-wrap">
                <div className="media-inq">
                  ...
                  <div className="inq-info-wrap">
                    ...
                    <div className="inq-info">
                      <p>Email</p>
                      <a href="mailto:squimby@hydrogen196.com">
                        squimby@hydrogen196.com
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <Row className='g-4'>
                  ...
                  <Col md='12'>
                    ...
                    <div className='form-check'>
                      ...
                      />
                      <label className='form-check-label'>
                        I accept to receive communication from Hydrogen196
                      </label>
                    </div>
                  </Col>
